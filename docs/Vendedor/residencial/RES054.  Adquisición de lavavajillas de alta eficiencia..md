...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        3. Factura del punto de venta con el contenido mínimo que se muestra a continuación: a) Datos del establecimiento comercial o punto de venta: nombre/razón social, NIF/NIE y dirección completa. b) Datos del pagador de la factura: nombre, DNI/NIF y dirección completa. c) Marca y modelo del lavavajillas o lavavajillas nuevos indicando la clasificación energética.
        </label></br>
        ...
        4. Etiqueta energética o código QR equivalente del lavavajillas nuevo.
        </label></br>

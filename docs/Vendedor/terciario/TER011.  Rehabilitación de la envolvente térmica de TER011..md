...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        4. Informe fotográfico del inmueble antes y después de la actuación con identificación de la superficie rehabilitada por la actuación.
        </label></br>
        ...
        5. Certificado suscrito por la persona directora o responsable de la obra, incluyendo: a) Cálculo justificado de la superficie de la envolvente de todo el edificio y superficie de la envolvente sobre la que se ha actuado o rehabilitado. b) Cálculo de los coeficientes globales de transmisión de calor a través de la envolvente térmica antes y después de la intervención. c) Los valores de las variables de la fórmula de cálculo del ahorro de energía del apartado
        </label></br>
        ...
        6. Certificado de eficiencia energética del edificio
        </label></br>
        ...
        7. Certificado de eficiencia energética del edificio, emitido tras la actuación ejecutada, con el justificante de registro y realizado con la misma herramienta informática
        </label></br>

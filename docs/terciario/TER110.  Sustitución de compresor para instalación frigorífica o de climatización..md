...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        6. Cuando sea preceptivo deberá aportarse la copia de la comunicación de la puesta en servicio de la nueva instalación frigorífica, Si no se aporta el documento de punto
        </label></br>

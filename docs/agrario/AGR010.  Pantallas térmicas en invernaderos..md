...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        4. Informe fotográfico antes y después de la actuación, que incluya las coordenadas geográficas.
        </label></br>
        ...
        5. Declaración responsable donde figuren los cultivos y la duración de sus ciclos anuales expresados en horas, formalizada por el técnico responsable y de acuerdo con el cuaderno de campo.
        </label></br>
        ...
        6. Declaración responsable formalizada por técnico competente, relativa al cálculo del coeficiente global de pérdidas de calor por conducción-convección antes y después de la actuación (K y K )
        </label></br>

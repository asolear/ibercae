...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        4. Certificados de instalación eléctrica (CIE), anterior y posterior a la actuación, firmados por la empresa instaladora habilitada de acuerdo con el Reglamento Electrotécnico para Baja Tensión (REBT), y registrado en el órgano competente de la comunidad autónoma, que incluya los valores de las variables de la fórmula de cálculo de ahorro de energía del apartado
        </label></br>
        ...
        5. Cuando sea preceptivo, copia de la comunicación de la puesta en funcionamiento de la instalación de iluminación.
        </label></br>

...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        4. Fotografías de los motores nuevos de alta eficiencia energética y antiguos en su entorno.
        </label></br>
        ...
        5. Certificado de instalación del motor expedido por la empresa habilitada que detalle los valores de las variables de la fórmula de cálculo de ahorro de energía del apartado
        </label></br>
        ...
        6. Ficha técnica y placa de características (número de polos, conexiones y parámetros nominales de potencia) del motor antiguo y del nuevo motor de alta eficiencia energética.
        </label></br>

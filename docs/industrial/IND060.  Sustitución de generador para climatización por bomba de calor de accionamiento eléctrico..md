...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        4. Informe fotográfico del equipo antes y después de la actuación con identificación de los equipos afectados.
        </label></br>
        ...
        5. Cuando los valores de las variables de la fórmula difieran de los valores de referencia de las tablas de los anexos de esta ficha, se deberá aportar el certificado de la instalación de la empresa instaladora donde se detallen los valores de las variables de la fórmula de cálculo de ahorro de energía del apartado
        </label></br>
        ...
        6. En el caso de utilizar un fluido refrigerante, este certificado deberá
        </label></br>
        ...
        7. Cuando sea preceptivo, copia de la comunicación de la puesta en funcionamiento presentada en el registro habilitado por el órgano competente de la comunidad autónoma.
        </label></br>
        ...
        8. Si no se aportan los documentos de los puntos
        </label></br>

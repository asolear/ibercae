...
???+  "Expediente"
    ...
    ???+  "DOCUMENTACIÓN PARA JUSTIFICAR LOS AHORROS DE LA ACTUACIÓN Y SU REALIZACIÓN" 
        ...
        6. Informe justificativo de la central frigorífica realizado, firmado por la empresa frigorista según el nivel habilitación que disponga, en la que se certifiquen los valores de SEPR original y final, temperatura de evaporación y condensación por cada una de las líneas, el factor de demanda y el número de horas de funcionamiento anual.
        </label></br>
        ...
        7. Copia de la comunicación de la puesta en servicio presentada en el registro habilitado por el órgano competente de la comunidad autónoma.
        </label></br>
